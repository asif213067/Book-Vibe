    ...
    <section className="container mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mb-10 text-center">
        ...
        <p className="mx-auto max-w-2xl text-sm leading-7 text-slate-500 sm:text-base">
          Discover a selection of captivating books, timeless classics, and exciting stories chosen for every kind of reader. Explore our picks and find your next great read.
        </p>
      </div>
